...
const Page: React.FC = () => {
  ...
  return (
    <Fragment>
      {/* Head: Metadatos específicos para la página */}
      <Head>
        <title>Collatz Conjecture - Iesus Dev</title>
        <meta
          name="description"
          content="Explore the Collatz Conjecture through interactive charts and visualizations. Analyze sequences and learn how numbers evolve in this mathematical challenge."
        />
        <meta
          name="keywords"
          content="Collatz, Mathematics, Graphs, Charts, Sequences, Iesus Dev"
        />
        <meta
          property="og:title"
          content="Collatz Conjecture - Interactive Visualization"
        />
        <meta
          property="og:description"
          content="An interactive exploration of the Collatz Conjecture using charts and data visualizations. Discover the beauty of mathematics!"
        />
            ...
            <div className={`text-lg `}>
              {myLanguage === "eng" ? (
                ...
                <span>
                  ...
                  cualquier número entero positivo, si el número es par,
                  divídelo entre 2, y si es impar, multiplícalo por 3 y súmale
                  1. La conjetura afirma que, sin importar el número inicial, la
